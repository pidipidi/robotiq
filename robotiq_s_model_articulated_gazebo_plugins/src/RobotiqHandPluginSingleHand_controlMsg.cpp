...
#include <robotiq_s_model_articulated_gazebo_plugins/RobotiqHandPluginSingleHand_controlMsg.h>
#undef private

// Default topic names initialization.
//const std::string RobotiqHandPluginSingleHand_controlMsg::DefaultLeftTopicCommand  =
  //"/left_hand/command";
//const std::string RobotiqHandPluginSingleHand_controlMsg::DefaultLeftTopicState    =
  //"/left_hand/state";
//const std::string RobotiqHandPluginSingleHand_controlMsg::DefaultRightTopicCommand =
  //"/right_hand/command";
//const std::string RobotiqHandPluginSingleHand_controlMsg::DefaultRightTopicState   =
  //"/right_hand/state";
...
////////////////////////////////////////////////////////////////////////////////
RobotiqHandPluginSingleHand_controlMsg::RobotiqHandPluginSingleHand_controlMsg()
{
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand_controlMsg::Load(gazebo::physics::ModelPtr _parent,
                             sdf::ElementPtr _sdf)
{
  this->model = _parent;
  ...
  ros::SubscribeOptions handleCommandSo =
    ros::SubscribeOptions::create<robotiq_s_model_control::SModel_robot_output>(
      ...
      boost::bind(&RobotiqHandPluginSingleHand_controlMsg::SetHandleCommand, this, _1),
  ...
  this->callbackQueueThread =
    boost::thread(boost::bind(&RobotiqHandPluginSingleHand_controlMsg::RosQueueThread, this));

  // Connect to gazebo world update.
  this->updateConnection =
    gazebo::event::Events::ConnectWorldUpdateBegin(
      boost::bind(&RobotiqHandPluginSingleHand_controlMsg::UpdateStates, this));

  // Log information.
  //gzlog << "RobotiqHandPluginSingleHand_controlMsg loaded for " << this->side << " hand."
        //<< std::endl;
  for (int i = 0; i < this->NumJoints; ++i)
  {
...
////////////////////////////////////////////////////////////////////////////////
bool RobotiqHandPluginSingleHand_controlMsg::VerifyField(const std::string &_label, int _min,
  int _max, int _v)
{
  if (_v < _min || _v > _max)
  {
...
////////////////////////////////////////////////////////////////////////////////
bool RobotiqHandPluginSingleHand_controlMsg::VerifyCommand(
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand_controlMsg::SetHandleCommand(
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand_controlMsg::ReleaseHand()
{
  // Open the fingers.
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand_controlMsg::StopHand()
{
...
////////////////////////////////////////////////////////////////////////////////
bool RobotiqHandPluginSingleHand_controlMsg::IsHandFullyOpen()
{
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand_controlMsg::UpdateStates()
{
  boost::mutex::scoped_lock lock(this->controlMutex);
...
////////////////////////////////////////////////////////////////////////////////
uint8_t RobotiqHandPluginSingleHand_controlMsg::GetObjectDetection(
...
////////////////////////////////////////////////////////////////////////////////
uint8_t RobotiqHandPluginSingleHand_controlMsg::GetCurrentPosition(
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand_controlMsg::GetAndPublishHandleState()
{
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand_controlMsg::GetAndPublishJointState(
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand_controlMsg::UpdatePIDControl(double _dt)
{
...
////////////////////////////////////////////////////////////////////////////////
bool RobotiqHandPluginSingleHand_controlMsg::GetAndPushBackJoint(const std::string& _jointName,
                                            gazebo::physics::Joint_V& _joints)
{
  ...
  gzlog << "RobotiqHandPluginSingleHand_controlMsg found joint [" << _jointName << "]" << std::endl;
  return true;
}

////////////////////////////////////////////////////////////////////////////////
bool RobotiqHandPluginSingleHand_controlMsg::FindJoints()
{
  ...
  //gzlog << "RobotiqHandPluginSingleHand_controlMsg found all joints for " << this->side
        //<< " hand." << std::endl;
  return true;
}

////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand_controlMsg::RosQueueThread()
{
...
GZ_REGISTER_MODEL_PLUGIN(RobotiqHandPluginSingleHand_controlMsg)
