...
#include <robotiq_s_model_articulated_gazebo_plugins/RobotiqHandPluginSingleHand.h>
#undef private
...
////////////////////////////////////////////////////////////////////////////////
RobotiqHandPluginSingleHand::RobotiqHandPluginSingleHand()
{
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand::Load(gazebo::physics::ModelPtr _parent,
                             sdf::ElementPtr _sdf)
{
  this->model = _parent;
  ...
  ros::SubscribeOptions handleCommandSo =
    ros::SubscribeOptions::create<robotiq_s_model_articulated_msgs::SModelRobotOutput>(
      ...
      boost::bind(&RobotiqHandPluginSingleHand::SetHandleCommand, this, _1),
  ...
  this->callbackQueueThread =
    boost::thread(boost::bind(&RobotiqHandPluginSingleHand::RosQueueThread, this));
...
////////////////////////////////////////////////////////////////////////////////
bool RobotiqHandPluginSingleHand::VerifyField(const std::string &_label, int _min,
  int _max, int _v)
{
  if (_v < _min || _v > _max)
  {
...
////////////////////////////////////////////////////////////////////////////////
bool RobotiqHandPluginSingleHand::VerifyCommand(
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand::SetHandleCommand(
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand::ReleaseHand()
{
  // Open the fingers.
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand::StopHand()
{
...
////////////////////////////////////////////////////////////////////////////////
bool RobotiqHandPluginSingleHand::IsHandFullyOpen()
{
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand::UpdateStates()
{
  boost::mutex::scoped_lock lock(this->controlMutex);
...
////////////////////////////////////////////////////////////////////////////////
uint8_t RobotiqHandPluginSingleHand::GetObjectDetection(
...
////////////////////////////////////////////////////////////////////////////////
uint8_t RobotiqHandPluginSingleHand::GetCurrentPosition(
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand::GetAndPublishHandleState()
{
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand::GetAndPublishJointState(
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand::UpdatePIDControl(double _dt)
{
...
////////////////////////////////////////////////////////////////////////////////
bool RobotiqHandPluginSingleHand::GetAndPushBackJoint(const std::string& _jointName,
                                            gazebo::physics::Joint_V& _joints)
{
  ...
  gzlog << "RobotiqHandPluginSingleHand found joint [" << _jointName << "]" << std::endl;
  return true;
}

////////////////////////////////////////////////////////////////////////////////
bool RobotiqHandPluginSingleHand::FindJoints()
{
...
////////////////////////////////////////////////////////////////////////////////
void RobotiqHandPluginSingleHand::RosQueueThread()
{
...
GZ_REGISTER_MODEL_PLUGIN(RobotiqHandPluginSingleHand)
