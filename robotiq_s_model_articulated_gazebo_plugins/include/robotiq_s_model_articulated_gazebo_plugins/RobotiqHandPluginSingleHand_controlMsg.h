...
#ifndef GAZEBO_ROBOTIQ_HAND_PLUGIN_SINGLE_HAND_CONTROL_MSG_HH
#define GAZEBO_ROBOTIQ_HAND_PLUGIN_SINGLE_HAND_CONTROL_MSG_HH
...
///                   This parameter is optional.
class RobotiqHandPluginSingleHand_controlMsg : public gazebo::ModelPlugin
{
  ...
  /// \brief Constructor.
  public: RobotiqHandPluginSingleHand_controlMsg();

  /// \brief Destructor.
  public: virtual ~RobotiqHandPluginSingleHand_controlMsg();
